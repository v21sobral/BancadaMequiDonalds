...
function Midia({ token, usuario }) {
  ...
  const abrir = (item) => { setErroEmbed(false); setAtivo(item); };
  ...
  return <section className="midia-page page-shell"><div className="container">
    ...
    {ativo && <div className="midia-player">
      <div className="midia-player-head"><strong>{ativo.titulo}</strong><button onClick={() => setAtivo(null)}>Fechar</button></div>
      {!erroEmbed ? (
        <iframe
          src={src}
          title={ativo.titulo}
